...
class PaymentScreen extends StatefulWidget {
  final Function(double amount, String transactionId, DateTime paymentDate) onPaymentSuccess;
  ...
  Future<void> _submitPayment() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        final transactionId = DateTime.now().millisecondsSinceEpoch.toString(); // Mock transaction ID
        final paymentDate = DateTime.now();
        
        widget.onPaymentSuccess(amount, transactionId, paymentDate);
